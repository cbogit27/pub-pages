export default function PostSkeleton() {
    return (
      <div className="max-w-4xl mx-auto px-4 animate-pulse">
        ...
        {/* Image Skeleton */}
        <div className="relative h-48 md:h-64 lg:h-96 bg-gray-800 rounded mb-8"></div>
  
        {/* Title Skeleton */}
        <div className="h-8 w-3/4 bg-gray-800 rounded mb-4"></div>
  
        {/* Description Skeleton */}
        <div className="h-5 w-full bg-gray-800 rounded mb-2"></div>
        <div className="h-5 w-2/3 bg-gray-800 rounded mb-6"></div>
